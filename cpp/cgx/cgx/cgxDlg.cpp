...
BEGIN_MESSAGE_MAP(CcgxDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CcgxDlg::OnBnClickedButton1)
	ON_MESSAGE (WM_HOTKEY, &CcgxDlg::OnHotkey)
	ON_BN_CLICKED(IDC_TIME2SCREENSHOT, &CcgxDlg::OnBnClickedTime2screenshot)
	ON_BN_CLICKED(IDC_SPEED_UP_WALK, &CcgxDlg::OnBnClickedSpeedUpWalk)
END_MESSAGE_MAP()
...
void CcgxDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
